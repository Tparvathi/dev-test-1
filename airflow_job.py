...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-pm")
    bq_project = Variable.get("bq_project", default_var="genial-charter-444622-f4")
    ...
    batch_details = {
        "pyspark_batch": {
            ...
            "python_file_uris": [],  # Python WHL files need to download python wheel files from internet and place in the storage
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "496782099357-compute@developer.gserviceaccount.com",
                "network_uri": "projects/genial-charter-444622-f4/global/networks/default",
                "subnetwork_uri": "projects/genial-charter-444622-f4/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="genial-charter-444622-f4",
        region="us-central1",
